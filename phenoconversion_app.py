...
tab1, tab2, tab3, tab4, tab5 = st.tabs(["Klinik özet", "Grafikler", "Senaryo simülasyonu", "Varyant kütüphanesi", "Literatür"])
...
st.divider()
st.caption("V2 · Kural tabanlı eğitim aracı · Sonuçlar kaynak sürümü ve klinik bağlamla doğrulanmalıdır.")
